			...
			<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
				...
				<?php if ( bp_is_active( 'xprofile' ) && !(int)bp_get_option( 'bp-disable-avatar-uploads' ) ) : ?>
					...
					<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
						...
						<h4><?php _e( 'Your Current Profile Picture', 'buddypress' ) ?></h4>
						<p><?php _e( "We've fetched an Profile Picture for your new account. If you'd like to change this, why not upload a new one?", 'buddypress' ) ?></p>
					...
					<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
						...
						<h3><?php _e( 'Crop Your New Profile Picture', 'buddypress' ) ?></h3>

						<img src="<?php bp_avatar_to_crop() ?>" id="avatar-to-crop" class="avatar" alt="<?php _e( 'Profile Picture to crop', 'buddypress' ) ?>" />

						<div id="avatar-crop-pane">
							<img src="<?php bp_avatar_to_crop() ?>" id="avatar-crop-preview" class="avatar" alt="<?php _e( 'Profile Picture preview', 'buddypress' ) ?>" />
						</div>
