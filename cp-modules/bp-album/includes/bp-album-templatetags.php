...
function bp_album_picture_desc() {
	...
	function bp_album_get_picture_desc() {
		global $pictures_template;
		// JLL_MOD - Strip tgas from photo description
		$predesc = apply_filters( 'bp_album_get_picture_desc', $pictures_template->picture->description );
		$desc = strip_tags($predesc);
		return $desc;
	}
...
function bp_album_adjacent_links() {
	...
	function bp_album_get_adjacent_links() {
		...
		if ($pictures_template->has_prev_pic() || $pictures_template->has_next_pic())
			...
			return '<a href="'.bp_album_get_pictures_url().'" class="picture-album-link picture-no-adjacent-link remover"><span>'.bp_word_or_name( __( "Return to your album", 'bp-album' ), __( "Return to %s album", 'bp-album' ) ,false,false ).'</span> </a>';
	} 
...
function bp_album_next_picture_link($text = ' &raquo;', $title = true) {
	...
	function bp_album_get_next_picture_link($text = ' &raquo;', $title = true) {
		...
		if ($pictures_template->has_next_pic()){
			...
			return '<a href="'.bp_album_get_next_picture_url().'" class="picture-next-link remover"> <span>'.$text.'</span></a>';
		}
		else
			return null;
	}
...
function bp_album_next_picture_or_album_link($text = ' &raquo;', $title = true) {
	...
	function bp_album_get_next_picture_or_album_link($text = ' &raquo;', $title = true) {
		...
		if ($pictures_template->has_next_pic()){
			...
			return '<a href="'.bp_album_get_pictures_url().'" class="picture-album-link picture-next-link remover"> <span> '.bp_word_or_name( __( "Return to your album", 'bp-album' ), __( "Return to %s album", 'bp-album' ) ,false,false ).'</span></a>';
	}
...
function bp_album_prev_picture_link($text = '&laquo; ', $title = true) {
	...
	function bp_album_get_prev_picture_link($text = '&laquo; ', $title = true) {
		...
		if ($pictures_template->has_prev_pic()){
			...
			return '<a href="'.bp_album_get_prev_picture_url().'" class="picture-prev-link remover"><span>'.$text.'</span> </a>';
		}
		else
			return null;
	}
...
function bp_album_prev_picture_or_album_link($text = '&laquo; ', $title = true) {
	...
	function bp_album_get_prev_picture_or_album_link($text = '&laquo; ', $title = true) {
		...
		if ($pictures_template->has_prev_pic()){
			...
			return '<a href="'.bp_album_get_pictures_url().'" class="picture-album-link picture-prev-link remover"><span> '.bp_word_or_name( __( "Return to your album", 'bp-album' ), __( "Return to %s album", 'bp-album' ) ,false,false ).'</span> </a>';
	}
