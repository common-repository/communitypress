...
{ 
    global $jfb_name;
	add_submenu_page( 'bp-general-settings','FB Connect', 'FB Connect', 'manage_options', "wp-fb-autoconnect", 'jfb_admin_page' );
}
...
function jfb_admin_page()
{
    ...
    <br />That's it!  A Facebook button will be automatically added to the login page.<br /><br />
    ...
    <form name="formMainOptions" method="post" action="">
        ...
        <input style="display: none;" type="radio" name="<?php echo $opt_jfb_username_style; ?>" value="0" <?php echo (get_option($opt_jfb_username_style)==0?"checked='checked'":"")?> >
        <input style="display: none;" type="radio" name="<?php echo $opt_jfb_username_style; ?>" value="1" <?php echo (get_option($opt_jfb_username_style)==1?"checked='checked'":"")?> >
        <input style="display: none;" type="radio" name="<?php echo $opt_jfb_username_style; ?>" value="2" <?php echo (get_option($opt_jfb_username_style)==2?"checked='checked'":"")?> >
		...
		<?php add_option($opt_jfb_stream_content, "has connected to " . get_option('blogname')); ?>
		...
		<br /><b>Profile Pictures:</b><br />
        <input type="checkbox" name="<?php echo $opt_jfb_wp_avatars?>" value="1" <?php echo get_option($opt_jfb_wp_avatars)?'checked="checked"':''?> /> Use Facebook profile pictures as CommunityPress Profile Pictures<br />
