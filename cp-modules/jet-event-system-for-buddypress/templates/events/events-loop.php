...
<script type="text/javascript" src="<?php echo WP_PLUGIN_URL . '/communitypress/cp-modules/jet-event-system-for-buddypress/js/fullcalendar.min.js'; ?>"></script>
<?php	require_once ( WP_PLUGIN_DIR . '/communitypress/cp-modules/jet-event-system-for-buddypress/main/jet-events-themetemplate.php' ); ?>
...
// Loop Templates
		if ($jes_adata['jes_events_style'] != 'Custom' )
			{
				require_once ( WP_PLUGIN_DIR . '/communitypress/cp-modules/jet-event-system-for-buddypress/main/jet-events-themetemplate.php' );
			}
