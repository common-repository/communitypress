...
// JLL_MOD - Deleted plugin header and version number
/***
...
require_once( WP_PLUGIN_DIR . '/communitypress/cp-core/bp-core.php' );
...
// JLL_MOD - add wall component
	include( BP_PLUGIN_DIR . '/cp-wall.php' );
}
/**
 * bp_loaded()
 * 
...
register_activation_hook( 'cp-core/bp-loader.php', 'bp_loader_activate' );
