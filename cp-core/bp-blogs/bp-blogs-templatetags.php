...
function bp_directory_blogs_search_form() {
	...
	<form action="" method="get" id="search-blogs-form">
		<label><input type="text" name="s" id="blogs_search" value="<?php if ( isset( $_GET['s'] ) ) { echo $_GET['s']; } else { _e( ' Search blogs...', 'buddypress' ); } ?>"  onfocus="if (this.value == '<?php _e( ' Search blogs...', 'buddypress' ) ?>') {this.value = '';}" onblur="if (this.value == '') {this.value = '<?php _e( ' Search blogs...', 'buddypress' ) ?>';}" /></label>
