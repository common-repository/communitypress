...
<?php } ?>
		...
		<?php } else { ?>
			<input name="jes-send-outlook" class="eventstyle" type="image" value="iPhone" src="<?php echo WP_PLUGIN_URL ?>/communitypress/cp-modules/jet-event-system-for-buddypress/images/outlook.png" onClick="return onChoseOutlook(this.form)">
		<?php } ?>
		...
		<?php } else { ?>
			<input name="jes-send-iphone" class="eventstyle" type="image" value="Outlook" src="<?php echo WP_PLUGIN_URL ?>/communitypress/cp-modules/jet-event-system-for-buddypress/images/iphone.png" onClick="return onChoseiPhone(this.form)">
		<?php } ?>
		</form>
	</div>
