...
if ( bp_has_activities( 'scope=groups' ) ) :
while ( bp_activities() ) : bp_the_activity();
$wall_id_list_b .= bp_get_activity_id() . ',';
endwhile;
endif;
if ( bp_has_activities( 'scope=favorites' ) ) :
while ( bp_activities() ) : bp_the_activity();
$wall_id_list_c .= bp_get_activity_id() . ',';
endwhile;
endif;
if ( bp_has_activities( 'scope=mentions' ) ) :
while ( bp_activities() ) : bp_the_activity();
$wall_id_list_d .= bp_get_activity_id() . ',';
endwhile;
endif;
$wall_id_list_all = $wall_id_list_a . $wall_id_list_b . $wall_id_list_c . $wall_id_list_d;
