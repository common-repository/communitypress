...
<?php if ( !(int)bp_get_option( 'bp-disable-avatar-uploads' ) ) : ?>
	...
	<p><?php _e( 'Upload a new Profile Picture and crop it. No one likes the default ones :P ', 'buddypress') ?></p>
	...
	<form action="" method="post" id="avatar-upload-form" enctype="multipart/form-data">
		...
		<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<?php if ( bp_get_user_has_avatar() ) : ?>
				<p><?php _e( "If you'd like to delete your current Profile Picture but not upload a new one, please use the delete button.", 'buddypress' ) ?></p>
		...
		<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<h5><?php _e( 'Crop Your Profile Picture', 'buddypress' ) ?></h5>
